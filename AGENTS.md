...
| **Build cache E12** (một lần, ~45 phút) | `notebooks/15_build_cache_e12.ipynb` trên Kaggle | sẵn sàng (WORKLOG S-111), **chưa chạy**. Chỉ build, không train. Lưu output thành Kaggle Dataset rồi mount cho mọi session sau — build lại mỗi session là mất gần một fold |
